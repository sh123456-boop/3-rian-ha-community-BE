...
('profiles/loadtest-user-01.png', (SELECT user_id FROM users WHERE email = 'loadtest1@example.com')),
('profiles/loadtest-user-02.png', (SELECT user_id FROM users WHERE email = 'loadtest2@example.com')),
('profiles/loadtest-user-03.png', (SELECT user_id FROM users WHERE email = 'loadtest3@example.com')),
('profiles/loadtest-user-04.png', (SELECT user_id FROM users WHERE email = 'loadtest4@example.com')),
('profiles/loadtest-user-admin.png', (SELECT user_id FROM users WHERE email = 'loadtest-admin@example.com'));

-- 3. Pre-create post image metadata so PostImage rows can reference stable IDs
INSERT INTO images (s3_key) VALUES
('posts/loadtest-01-main.png'),
('posts/loadtest-01-detail.png'),
('posts/loadtest-02-main.png'),
('posts/loadtest-02-detail.png'),
('posts/loadtest-03-main.png'),
('posts/loadtest-03-detail.png'),
('posts/loadtest-04-main.png'),
('posts/loadtest-04-detail.png'),
('posts/loadtest-05-main.png'),
('posts/loadtest-05-detail.png'),
('posts/loadtest-06-main.png'),
('posts/loadtest-06-detail.png'),
('posts/loadtest-07-main.png'),
('posts/loadtest-07-detail.png'),
('posts/loadtest-08-main.png'),
('posts/loadtest-08-detail.png'),
('posts/loadtest-09-main.png'),
('posts/loadtest-09-detail.png'),
('posts/loadtest-10-main.png'),
('posts/loadtest-10-detail.png'),
('posts/loadtest-11-main.png'),
('posts/loadtest-11-detail.png'),
('posts/loadtest-12-main.png'),
('posts/loadtest-12-detail.png'),
('posts/loadtest-13-main.png'),
('posts/loadtest-13-detail.png'),
('posts/loadtest-14-main.png'),
('posts/loadtest-14-detail.png'),
('posts/loadtest-15-main.png'),
('posts/loadtest-15-detail.png');
...
((SELECT post_id FROM posts WHERE title = 'Load Test Post 01'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-01-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 01'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-01-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 02'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-02-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 02'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-02-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 03'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-03-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 03'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-03-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 04'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-04-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 04'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-04-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 05'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-05-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 05'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-05-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 06'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-06-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 06'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-06-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 07'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-07-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 07'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-07-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 08'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-08-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 08'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-08-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 09'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-09-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 09'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-09-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 10'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-10-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 10'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-10-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 11'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-11-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 11'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-11-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 12'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-12-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 12'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-12-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 13'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-13-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 13'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-13-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 14'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-14-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 14'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-14-detail.png'), 2),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 15'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-15-main.png'), 1),
((SELECT post_id FROM posts WHERE title = 'Load Test Post 15'), (SELECT image_id FROM images WHERE s3_key = 'posts/loadtest-15-detail.png'), 2);
