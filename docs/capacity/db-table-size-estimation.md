...
이 문서는 현재 서비스의 ERD(엔티티 구조)를 기준으로,

- 엔티티별 **1 row 당 저장 용량**을 추정하고
- 주요 쓰기 작업(회원가입, 게시글 작성, 채팅 등)에 따른 **월간 데이터 증가량**을 계산한 뒤
- InnoDB 특성(페이지 단편화 등)을 감안하여 **월/3년 기준 필요 스토리지 용량**을 추정하기 위한 문서입니다.
